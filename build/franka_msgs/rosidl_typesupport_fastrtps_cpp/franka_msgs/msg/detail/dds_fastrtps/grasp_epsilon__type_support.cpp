...
#include "franka_msgs/msg/detail/grasp_epsilon__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const franka_msgs::msg::GraspEpsilon & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  franka_msgs::msg::GraspEpsilon & ros_message)
{
  // Member: inner
  cdr >> ros_message.inner;
...
{
  auto typed_message =
    static_cast<const franka_msgs::msg::GraspEpsilon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<franka_msgs::msg::GraspEpsilon *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GraspEpsilon__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const franka_msgs::msg::GraspEpsilon *>(
...
static size_t _GraspEpsilon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GraspEpsilon(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GraspEpsilon__callbacks = {
  "franka_msgs::msg",
  "GraspEpsilon",
...
static rosidl_message_type_support_t _GraspEpsilon__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GraspEpsilon__callbacks,
...
{
  return &franka_msgs::msg::typesupport_fastrtps_cpp::_GraspEpsilon__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, msg, GraspEpsilon)() {
  return &franka_msgs::msg::typesupport_fastrtps_cpp::_GraspEpsilon__handle;
}
